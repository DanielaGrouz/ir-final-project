...
def get_bm25_scores(query: str):
    ...
    fields = [
        (body_inverted_index, BODY_STATS, 0.2, simple_tokenize, DL_BY_FIELD["body"]),  # Low noise
        (title_inverted_index, TITLE_STATS, 0.6, simple_tokenize, DL_BY_FIELD["title"]), # Max Signal
        (inverted_anchor, ANCHOR_STATS, 0.2, simple_tokenize, DL_BY_FIELD["anchor"]) # High Signal
    ]
