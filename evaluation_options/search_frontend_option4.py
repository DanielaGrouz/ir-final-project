...
def get_bm25_scores(query: str):
    ...
    fields = [
        ...
        (title_inverted_index, TITLE_STATS, 0.5, simple_tokenize, DL_BY_FIELD["title"]), # Max Signal
        (inverted_anchor, ANCHOR_STATS, 0.25, simple_tokenize, DL_BY_FIELD["anchor"]) # High Signal
    ]
