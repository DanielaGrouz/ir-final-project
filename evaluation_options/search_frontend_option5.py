...
def get_bm25_scores(query: str):
    ...
    fields = [
        ...
        (title_inverted_index, TITLE_STATS, 0.5, tokenize_smart, DL_BY_FIELD["title"]),
        (inverted_anchor, ANCHOR_STATS, 0.25, tokenize_anchor, DL_BY_FIELD["anchor"])
    ]
...
def rank_candidates(query, top_candidates_scores):
    ...
    for i, cid in enumerate(candidate_ids):
        ...
        final_score = (bm25_val * 0.4) + (sem_val * 0) + (pr_val * 0.3) + (pv_val * 0.3)
